...
Alan T. Arnholt and Ben Evans (2017). BSDA: Basic Statistics and Data Analysis. R
  package version 1.2.0. https://CRAN.R-project.org/package=BSDA

Alboukadel Kassambara (2016). ggcorrplot: Visualization of a Correlation Matrix using
  'ggplot2'. R package version 0.1.1. https://CRAN.R-project.org/package=ggcorrplot

Davis Vaughan and Matt Dancho (2018). tibbletime: Time Aware Tibbles. R package version
  0.1.1. https://CRAN.R-project.org/package=tibbletime

 Jeffrey A. Ryan and Joshua M. Ulrich (2017). quantmod: Quantitative Financial Modelling
  Framework. R package version 0.4-12. https://CRAN.R-project.org/package=quantmod
